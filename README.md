# E-Leads — Module for OpenCart 2.x
...
## Compatibility
- OpenCart: 2.x
- PHP: according to your OpenCart 2.x requirements.

## Installation
1. In admin: **Extensions → Extension Installer**.
2. Upload release archive: `eleads-opencart-2.x.ocmod.zip`.
...
├─ admin/view/template/extension/module/eleads.tpl
...
## Repository & Release
- Repository: `https://github.com/E-Leads-net/eleads-opencart-2`
